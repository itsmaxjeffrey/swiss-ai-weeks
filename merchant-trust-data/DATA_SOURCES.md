...
| AbuseIPDB | IP reputation (abuse confidence score) | `api.abuseipdb.com/api/v2/check` — **API key required** (401 unauthenticated, probe recorded 2026-09-24) | free tier: non-commercial w/ attribution | `LICENSE_REVIEW_REQUIRED` for raw responses | ✅ collected 2026-09-24 (owner key in gitignored .env): 1,000/5,091 IP hosts checked (free-tier daily cap; resumable queue), 999 ok / 1 err — remainder reruns tomorrow |
